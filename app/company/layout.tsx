...
const navItems = [
  ...
  { name: "Pasar Produk", href: "/company/products", icon: ShoppingCart },
  { name: "Bandingkan Supplier", href: "/company/compare", icon: BarChart3 },
  ...
  { name: "AI Match", href: "/company/ai-match", icon: Sparkles },
